...
exports.MetashrewPayments = void 0;
const wallet = __importStar(require("metashrew-runes/src.ts/wallet"));
const url_1 = __importDefault(require("url"));
const addHexPrefix = (s) => s.substr(0, 2) === '0x' ? s : '0x' + s;
let id = 0;
class MetashrewPayments {
    ...
    async sendersperpayment({ address: string }) {
...
exports.MetashrewPayments = MetashrewPayments;
